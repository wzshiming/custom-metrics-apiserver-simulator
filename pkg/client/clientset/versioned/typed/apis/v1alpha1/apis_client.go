...
import (
	...
	"github.com/wzshiming/custom-metrics-apiserver-simulator/pkg/client/clientset/versioned/scheme"
...
func (c *ApisV1alpha1Client) CustomMetrics() CustomMetricInterface {
	return newCustomMetrics(c)
}

func (c *ApisV1alpha1Client) ExternalMetrics(namespace string) ExternalMetricInterface {

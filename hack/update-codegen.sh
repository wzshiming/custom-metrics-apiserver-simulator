...
function gen() {
  ...
  deepcopy-gen \
    ...
    --trim-path-prefix github.com/wzshiming/custom-metrics-apiserver-simulator/pkg/apis \
  ...
  client-gen \
    ...
    --input-base "" \
    --input github.com/wzshiming/custom-metrics-apiserver-simulator/pkg/apis/v1alpha1 \
    --output-package github.com/wzshiming/custom-metrics-apiserver-simulator/pkg/client/clientset
}
